...
function InfoItemBlock({ item }: { item: InfoItem }) {
  const progressPercent = Math.min(100, Math.max(0, item.progressValue));
  ...
  return (
    <div className="grid items-center gap-11 lg:grid-cols-[1fr_1.3fr_1fr]">
      ...
      <div className="text-center">
        ...
        <div className="mb-3.5 font-body text-[0.78rem] text-ink-soft">{item.progressDescription}</div>
