...
export function Sakramenty() {
  ...
  const gridColsClass = topics.length >= 4 ? "lg:grid-cols-4" : "lg:grid-cols-3";
          ...
          {topics.map((topic) => {
            ...
            return (
              <button
                ...
                className={`rounded-lg border px-4 py-5 text-center transition-colors hover:bg-surface-muted ${
